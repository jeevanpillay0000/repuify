...
describe("rpc methods", () => {
  ...
  describe("eth_getKeyblockByHeight", () => {
    it("valid response", async () => {
      xhrUtility.setResponse({ meta: { hash: "0xa5b3d1dbafe79a41dce8ec33a83e68cf506cdcd1df7776c3afd8fc67a76cecf2" } });
      ...
      expect(ret.result.meta).to.have.property("hash", "0xa5b3d1dbafe79a41dce8ec33a83e68cf506cdcd1df7776c3afd8fc67a76cecf2");
    });
  ...
  describe("eth_getKeyblockByHash", () => {
    ...
    it("return null", async () => {
      ...
      const rpc = makeRPCRequest("eth_getKeyblockByHash", [
        100
      ]);
